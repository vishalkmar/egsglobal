...
const HEADING_TEXT = "HRD Stamping Services";

const HRDStampingBanner: React.FC = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-6 sm:gap-8 lg:gap-10 order-1">
              ...
              <p className="text-sm sm:text-base md:text-lg text-slate-800 font-light max-w-2xl leading-relaxed">
                HRD (Human Resource Development) stamping is a mandatory
                verification process for many international academic and
                employment requirements. EGS Group offers reliable and
                streamlined HRD stamping services to authenticate your
                educational documents directly through the respective State HRD
                departments. Our team ensures that your degrees, diplomas, and
                certificates are validated with complete accuracy, making them
                fully acceptable for overseas studies, work visas, and
            ...
            <div className="order-2 lg:order-2">
              <div className="w-full h-[260px] sm:h-[320px] md:h-[380px] lg:h-[420px] rounded-3xl overflow-hidden shadow-lg">
                <img
                  src="/hrdstamping.jpg"
                  alt="HRD stamping and document verification services"
...
export default HRDStampingBanner;
